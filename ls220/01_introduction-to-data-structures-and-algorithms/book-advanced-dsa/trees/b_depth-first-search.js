...
/* 
my solve
- preorderTraversal = NLR pattern.  Node first, then left and right.

base case
- node has no more children of that type

ALGO
- Process the node (append to result)
- if the left subtree exists, process it (recursive call)

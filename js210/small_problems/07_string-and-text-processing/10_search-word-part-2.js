/*
P
  return string with word 'highlighted' -> double asterisk and uppercased
E
D
A
*/
...
// MY SOLUTION
/* 
- Use regex to split the string on the word
- Reassemble the string, delimiting it with the highlighted word
...
function searchWord(word, textToSearch) {
  ...
  let passages = textToSearch.split(pattern)
  return passages.join(`**${word.toUpperCase()}**`)
}

// What's the prob wit hthe existing code?
// intent = extract specific column to a new array
...
/* 
Red flag = use of 'var' keyword

`var` keyword creates variables with function scope.  
Two vars are declared within one function scope.
The 2nd `length` replaces the first.

Lesson learned: BEWARE `var`
